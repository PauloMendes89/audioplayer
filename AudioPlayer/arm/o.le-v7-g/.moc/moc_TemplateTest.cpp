...
static const char qt_meta_stringdata_TemplateTest[] = {
    "TemplateTest\0\0QString\0musicDirectory\0"
    "getCurrentPath(QString)\0"
};
...
void TemplateTest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        TemplateTest *_t = static_cast<TemplateTest *>(_o);
        switch (_id) {
        case 0: { QString _r = _t->getCurrentPath((*reinterpret_cast< QString(*)>(_a[1])));
